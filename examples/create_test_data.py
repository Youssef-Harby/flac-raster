...
if __name__ == "__main__":
    ...
    print(f"   flac-raster convert {dem_file}")
    
    print(f"\n2. Convert RGB to FLAC:")
    print(f"   flac-raster convert {rgb_file}")
    
    print(f"\n3. Convert multispectral to FLAC:")
    print(f"   flac-raster convert {ms_file}")
    ...
    print(f"   flac-raster convert {dem_file}")
    print(f"   flac-raster convert test_data/sample_dem.flac")
    print(f"   flac-raster compare {dem_file} test_data/sample_dem.tif")
    
    print(f"\nAlternatively, use python main.py if not installed:")
    print(f"   python main.py convert {dem_file}")